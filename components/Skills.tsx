          ...
          {skills.map((cat, ci) => {
            ...
            return (
              <motion.div
                ...
                style={{
                  borderColor: isActive ? cs.color + '44' : 'rgba(255,255,255,0.07)',
                  background: isActive ? cs.bg : 'rgba(255,255,255,0.018)',
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-[10px] font-bold tracking-widest text-[#333] tabular-nums">
