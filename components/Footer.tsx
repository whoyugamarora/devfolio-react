...
export default function Footer() {
  return (
    <footer className="px-6 pt-8 pb-10 border-t border-[var(--border)] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between text-[var(--text-4)] text-xs relative z-10">
